...
class Logger:
    ...
    def __init__(self):
        ...
        self._logger.addHandler(self._get_file_handdler(self.filename))
        self._logger.addHandler(self._get_console_handler())
        self._logger.setLevel(logging.INFO)  # 默认等级

    def _get_file_handdler(self, filename):
        '''输出到日志文件'''
...
if __name__ == '__main__':
    ...
    logger.info('{}:开始***操作'.format(datetime.datetime.now()))